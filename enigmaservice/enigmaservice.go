...
// Letter lookus for converting runes into integers for arithmetic
...
// settingsHandler takes a settings object in json format and used it to set the EnigmaMachine object
func setHandler(w http.ResponseWriter, r *http.Request) {
	bodyBytes, _ := ioutil.ReadAll(r.Body)
	EnigmaMachine = loadSettingsFromBytes(bodyBytes)
	fmt.Fprintf(w, "Machine set.")
}
